...
public Character(string name, string weapon, string battleCry, int xp, float alignmentPercent, float movementSpeed,  bool isHero, int levelXp) {
...
public void PrintInfo() {
		...
		Debug.Log(GetPrintStatement(character, "Level", calculateLevelXp(xp, levelXp).ToString()));
